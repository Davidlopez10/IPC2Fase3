...
select*from  ORDEN
select*from PAGO
select CODIGOORDEN,PAGO.VALORPAGO,pago.TIPO from ORDEN inner join PAGO on ORDEN.CODIGOORDEN=PAGO.NOORDEN where ORDEN.ESTADOAPROBACION='ANULADO' and ORDEN.PAGOABONO='ANULADO'
