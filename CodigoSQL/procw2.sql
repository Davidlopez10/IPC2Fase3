...
select VENTAMETA,CONVERT(date,FECHA,103) from DETALLEMETA inner join METAS on detallemeta.codigometa=METAS.IDMETA where METAS.FECHA<='11/2014' and METAS.CODIGOEMPELADO='444000-4'
