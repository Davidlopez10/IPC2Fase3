...
select SUM(VENTAMETA) from DETALLEMETA inner join METAS on detallemeta.codigometa=METAS.IDMETA where (CONVERT(date,METAS.FECHA,103) BETWEEN CONVERT(date,'1/10/2014',103) AND CONVERT(date,'30/10/2014',103)) and METAS.CODIGOEMPELADO='444000-4'
select *from ORDEN
