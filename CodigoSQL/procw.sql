...
DELETE FROM PUESTO
DELETE FROM ORDEN
DELETE FROM DETALLEPRODUCTOORDEN
DELETE FROM CHEQUE
...
SELECT VALOR,CANTIDAD FROM DETALLEPRODUCTOORDEN INNER JOIN ORDEN ON DETALLEPRODUCTOORDEN.CODIGOORDEN=ORDEN.CODIGOORDEN WHERE ORDEN.CODIGOORDEN='2' AND ORDEN.NITCLIENTE='555555-5'
